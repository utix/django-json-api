...
class JSONAPIClient:
    ...
    def url_for_resource(self,
                         resource_type: str,
                         resource_id: Optional[ResourceId] = None) -> str:
    ...
    def _get_fields(self,
                    resource_type: str,
                    fields: Optional[Fields] = None) -> Dict[str, str]:
        model = get_model(resource_type)
        fields = fields or {}
    ...
    def _get_include(self,
                     resource_type: str,
                     include: Optional[Include] = None) -> Dict[str, str]:
        model = get_model(resource_type)
        if include is None:
            include = [
                fieldname
    ...
    def get(self,  # pylint: disable=too-many-arguments
            resource_type: str,
